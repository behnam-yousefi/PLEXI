...
#'
#' @param plexi.graph plexi.graph data
#' @param node.importance named numeric vector of the node importance to sort the nodes clockwise.
...
#' the main inputs to the function are: a graph multiplex (as an plexi.graph) and a vector of node importances.
#'
#' @examples
...
#'
subgraph_difference_plot = function(plexi.graph, node.importance,
